...
O sistema permite que funcionarios de uma loja de roupas consultem os produtos disponíveis no estoque da loja, assim como acrescentar novos itens ou remover. 🚀✨


### Estrutura do projeto
O sistema é feito em python e a inerface gráfica em Tkinter, utilizando o SQLITE como banco de dados.
